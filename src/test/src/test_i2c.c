...
TestStatus I2C_FunctionTest10(void)
{
    ...
    /* write mem_init data */
    DDR_WriteMem((uint8_t *)TxData, 0x10000000, MEM_INIT_SIZE);
    /* Init command buffer */
    DDR_WriteMem((uint8_t *)DMA_CmdBuf, 0x0, DMA_CMDBUF_SIZE);
    /* Enable FE kickoff */
...
TestStatus I2C_FunctionTest11(void)
{
    ...
    DDR_WriteMem((uint8_t *)Instruction, 0x4000000, INSTRUCTION_SIZE);
    /* write mem_init data */
    DDR_WriteMem((uint8_t *)TxData, 0x10000000, MEM_INIT_SIZE);
    /* Init command buffer */
    DDR_WriteMem((uint8_t *)SHD_CmdBuf, 0x0, SHD_CMDBUF_SIZE);
    /* Enable FE kickoff */
